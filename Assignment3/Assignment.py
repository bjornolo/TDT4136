...
class CSP:
    ...
    def add_constraint_one_way(self, i: str, j: str, filter_function: callable): # type: ignore
    ...
    def add_all_different_constraint(self, var_list: list):
        """Add an All different constraint between all of the variables in the
        list provided.
    ...
    def select_unassigned_variable(self, assignment):
        ...
        """
        #select unassigned variable, i.e. variable with length > 1
